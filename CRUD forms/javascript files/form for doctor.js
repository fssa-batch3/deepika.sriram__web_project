function uploadDoctor(e) {
  ...
  let exist = doctor_detail.some((data) => data.Doctor_name.trim().toLowerCase() == Doctor_name.toLowerCase());
  ...
  if (!exist) {
    ...
    // Experience = JSON.stringify(experienceObj);
    doctor_detail.push({
      Doctor_name, Doctor_image, Qualifications, Experience, Departments, Hospital_id, Working_days, Availabilities, uuid,
    });
