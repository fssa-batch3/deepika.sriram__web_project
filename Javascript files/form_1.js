function enter(e) {
  ...
  const exist = user_detail.some((data) => data.f_name.trim().toLowerCase() == f_name.toLowerCase()
  ...
  if (!exist) {
    if (create_password === confirm_password) {
      user_detail.push({
        f_name, l_name, age, user_gender, mobile, email_id, create_password, confirm_password, user_role, uuid,
      });
...
function signIn(e) {
  ...
  const exist = user_detail.length
